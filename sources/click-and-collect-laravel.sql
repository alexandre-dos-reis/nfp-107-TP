...
DROP DATABASE IF EXISTS `click-and-collect-laravel`;
CREATE DATABASE `click-and-collect-laravel` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `click-and-collect-laravel`;
